...
The general configuration and params of the workflows is set in the `config.json` file. Runnerty will try to get the `config.json` file in the current path.
